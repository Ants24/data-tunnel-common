...
func WriteData(ctx context.Context, logger Logger, tableConfig TaskFullTable, columnNames []string, columnTypes []string,
	dataChannel chan []sql.NullString,
	...
	insertSingleData func(ctx context.Context, logger Logger, rows [][]interface{}, columnNames []string, tableConfig TaskFullTable) (uint64, uint64, error)) error {
...
func GenerateSubTask(ctx context.Context, logger Logger, taskConfig TaskFullTable, getTablePrimaryKeys func(ctx context.Context, logger Logger, schemaName string, tableName string) ([]string, error), getTablePartitionNames func(ctx context.Context, logger Logger, schemaName string, tableName string) ([]string, error), getSplitValue func(ctx context.Context, logger Logger, taskConfig TaskFullTable) ([]interface{}, error)) ([]TaskFullTable, error) {
...
func generateSubTasksForKeys(ctx context.Context, logger Logger, taskConfig TaskFullTable, primaryKeys, partitionKeys []string, getSplitValue func(ctx context.Context, logger Logger, taskConfig TaskFullTable) ([]interface{}, error)) []TaskFullTable {
	subTasks := make([]TaskFullTable, 0)
...
func generateSubTasksWithoutPartitions(ctx context.Context, getSplitValue func(ctx context.Context, logger Logger, taskConfig TaskFullTable) ([]interface{}, error), logger Logger, taskConfig TaskFullTable, primaryKeys []string) []TaskFullTable {
	subTasks := make([]TaskFullTable, 0)
